...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        # elif self.epsilon_mode == 3:
        # self.train_times += 1
        # self.epsilon = 1 / math.pow(self.train_times, 2)
        # self.epsilon = math.exp(- self.a * self.train_times)
        # self.epsilon = math.cos(self.a * self.train_times)
        self.train_times += 1
        self.epsilon = 1 / (self.train_times ** 2)
        # self.epsilon = math.fabs(math.cos(self.alpha * self.train_times))
